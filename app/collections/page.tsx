        ...
        <div className="bg-black text-white min-h-screen pt-32 pb-24">
            <div className="px-6 max-w-7xl mx-auto space-y-24">
                <div className="text-center space-y-6">
                    <h1 className="text-6xl md:text-9xl font-serif italic tracking-tighter uppercase">Vaults</h1>
                    <p className="text-gold uppercase tracking-[0.5em] text-[10px] font-light max-w-md mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    {collections.map((col, i) => (
                        <div key={i} className="group relative border border-white/5 bg-zinc-950 p-12 space-y-12 hover:border-gold/30 transition-all duration-700 overflow-hidden">
                            <div className="relative z-10 space-y-6">
                                <div className="text-gold/50 group-hover:text-gold transition-colors duration-500">
                                    {col.icon}
                                </div>
                                <div>
                                    <h3 className="text-[10px] uppercase tracking-[0.3em] text-zinc-500 mb-2">{col.subtitle}</h3>
                                    <h2 className="text-3xl font-serif text-white">{col.title}</h2>
                                </div>
                                <p className="text-xs text-zinc-500 leading-loose uppercase tracking-widest font-light">
                                    {col.description}
                                </p>
                                <Link href="/shop" className="flex items-center gap-4 text-gold uppercase text-[9px] tracking-[0.4em] pt-8 group-hover:translate-x-2 transition-transform duration-500">
