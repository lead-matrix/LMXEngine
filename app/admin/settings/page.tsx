...
export default async function AdminSettings() {
    ...
    return (
        <form action={updateStoreSettings} className="space-y-12 pb-24">
                ...
                <div className="lg:col-span-3 space-y-12">
                    ...
                    <section className="bg-zinc-950 border border-white/5 p-10 space-y-8">
                        ...
                        <div className="flex items-center justify-between p-6 bg-zinc-900/50 border border-white/5">
                            <div>
                                ...
                                <p className="text-[9px] text-zinc-500 uppercase tracking-widest mt-1">Toggle maintenance mode (Emergency Kill Switch)</p>
                            </div>
                            <input
                                type="checkbox"
                                name="storeEnabled"
                    ...
                    <section className="bg-zinc-950 border border-white/5 p-10 space-y-8">
                        ...
                        <div className="flex items-center justify-between p-6 bg-emerald-500/5 border border-emerald-500/10">
                            ...
                            <button type="button" className="text-[9px] uppercase tracking-widest text-zinc-500 hover:text-white transition-colors">Run Diagnostics</button>
                        </div>
                    </section>
                </div>
            </div>
